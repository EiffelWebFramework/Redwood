...
static const EIF_TYPE_INDEX egt_14_900 [] = {0xFF01,896,0xFFFF};
static const EIF_TYPE_INDEX egt_15_900 [] = {0xFF01,896,0xFFFF};
...
static const struct desc_info desc_900[] = {
	...
	{EIF_GENERIC(egt_13_900), -1, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_900), -1, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_900), -1, 0xFFFFFFFF},
};
void Init900(void)
{
	IDSC(desc_900, 0, 899);
	IDSC(desc_900 + 1, 1, 899);
	IDSC(desc_900 + 32, 404, 899);
}

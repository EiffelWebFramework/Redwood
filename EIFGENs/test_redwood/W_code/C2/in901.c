...
extern EIF_TYPED_VALUE F901_7900(EIF_REFERENCE);
extern EIF_TYPED_VALUE F901_7901(EIF_REFERENCE);
extern EIF_TYPED_VALUE F901_7902(EIF_REFERENCE);
extern void F901_7903(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F901_7900 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 900, Current, 1, 0, 13544);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(900, Current, 13544);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(5802, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
	RTDBGAL(Current, 0, 0xF80000DC, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(220, 0x01).id);
	tp1 = *(EIF_POINTER *)(loc1 + RTVA(2675, "item", loc1));
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4440, Dtype(tr1)))(tr1, up1x);
	RTNHOOK(3,1);
...
RTOID (F901_7901)
EIF_TYPED_VALUE F901_7901 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 13545);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(900, Current, 13545);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F901_7902)
EIF_TYPED_VALUE F901_7902 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 900, Current, 0, 0, 13546);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(900, Current, 13546);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000380, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {710,197,0xFFFF};
		EIF_TYPE typres0;
...
void F901_7903 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 900, Current, 0, 1, 13547);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 1);
	RTDBGEAA(900, Current, 13547);
...
{
	GTCX
	RTOTS (7901,F901_7901)
	RTOTS (7902,F901_7902)
}

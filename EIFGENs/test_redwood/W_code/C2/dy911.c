...
extern void F911_7949(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F911_7950(EIF_REFERENCE);
extern EIF_TYPED_VALUE F911_7951(EIF_REFERENCE);
extern void F911_8320(EIF_REFERENCE, int);
...
void F911_7949 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 910, Current, 1, 1, 13591);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(910, Current, 13591);
	RTCC(arg1, 910, l_feature_name, 1, eif_new_type(218, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5838, 0xF80000E4, 0); /* api_feature_name */
	...
	*(EIF_REFERENCE *)(Current + RTWA(5838, dtype)) = (EIF_REFERENCE) tr1;
	...
	if (RTAL & CK_ENSURE) {
		RTHOOK(9);
		RTCT("api_feature_name_set", EX_POST);
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5838, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(9,1);
		ur1 = RTCCL(arg1);
...
/* {DYNAMIC_API_UNAVAILABLE_EXCEPTION}.api_feature_name */
EIF_TYPED_VALUE F911_7950 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {DYNAMIC_API_UNAVAILABLE_EXCEPTION}.tag */
EIF_TYPED_VALUE F911_7951 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 910, Current, 0, 0, 13593);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(910, Current, 13593);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E5, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(229, 0x01).id);
	tr2 = RTMS_EX_H("API Missing in dynamic library.",31,1656856366);
	ur1 = tr2;
...
/* {DYNAMIC_API_UNAVAILABLE_EXCEPTION}._invariant */
void F911_8320 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_REF, &Current);
	RTLU(SK_REF, &loc1);
	RTEAINV(l_feature_name, 910, Current, 1, 8319);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("api_feature_name_attached", Current);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5838, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	RTIT("not_api_feature_name", Current);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5838, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	...
	RTIT("not_message_is_empty", Current);
	tb1 = '\0';
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1269, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
